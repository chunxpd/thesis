...
<h1>조회 페이지</h1>
	<form id="modifyForm" action="/thesis/board/modify" method="post">

		<div class="input_wrap">
			<label>게시판 번호</label> <input name="bno" readonly="readonly"  value='<c:out value="${pageInfo.bno}"/>'>
		</div>
		<div class="input_wrap">
			<label>게시판 제목</label> <input name="title" value='<c:out value="${pageInfo.title}"/>'>
		</div>
		<div class="input_wrap">
			<label>게시판 내용</label>
		...
		<div class="input_wrap">
			<label>게시판 작성자</label> <input name="writer" readonly="readonly" value='<c:out value="${pageInfo.writer}"/>'>
		</div>
		<div class="input_wrap">
		...
		<div class="input_wrap">
			<label>비밀번호</label> <input name="passwd" id = "passwd" value=''>
		</div>
		<div class="btn_wrap">
...
<script>
	...
	$("#cancel_btn").on("click", function(e) {
		form.attr("action", "/thesis/board/get");
		form.submit();
	});
	 /* 삭제 버튼 */
  /*   $("#delete_btn").on("click", function(e){
    	...
    	mForm.attr("action", "/thesis/board/delete");
